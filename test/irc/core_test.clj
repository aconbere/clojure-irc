...
(def messages (seq [
  ...
  ["USER guest tolmoon tolsun :Ronnie Reagan" [:message [:command "USER"] [:param "guest"] [:param "tolmoon"] [:param "tolsun"] [:param "Ronnie Regan"]]]
  [":testnick USER guest tolmoon tolsun :Ronnie Reagan" [:message [:prefix [:nick "testnick"]] [:command "USER"] [:param "guest"] [:param "tolmoon"] [:param "tolsun"] [:param "Ronnie Regan"]]]
